# Generated by Django 2.1.5 on 2019-02-17 13:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default=None, max_length=255, verbose_name='MiNegocito v0.1a')),
                ...
                ('disabled_reason', models.CharField(blank=True, default=None, max_length=1024, null=True, verbose_name='Especifique la razón para desactivar esta marca')),
                ...
                ('dropped_reason', models.CharField(blank=True, default=None, max_length=1024, null=True, verbose_name='Especifique la razón para eliminar esta marca')),
            ],
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default=None, max_length=255, verbose_name='Primer nombre')),
                ('disabled', models.BooleanField(default=False)),
                ('disabled_at', models.TimeField(blank=True, default=None, editable=False, null=True)),
                ('disabled_when', models.DateField(blank=True, default=None, editable=False, null=True)),
                ('disabled_reason', models.CharField(blank=True, default=None, max_length=1024, null=True, verbose_name='Specify the reason to disable this product')),
                ('dropped', models.BooleanField(default=False)),
                ('dropped_at', models.TimeField(blank=True, default=None, editable=False, null=True)),
                ('dropped_when', models.DateField(blank=True, default=None, editable=False, null=True)),
                ('dropped_reason', models.CharField(blank=True, default=None, max_length=1024, null=True, verbose_name='Specify the reason to drop this product')),
            ],
        ),
        migrations.CreateModel(
            name='Region',
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogues.Country')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogues.Country'),
        ),
        migrations.AddField(
            model_name='city',
            name='region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalogues.Region'),
        ),
