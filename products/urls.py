...
from products import search_urls
from products import autocomplete_urls
from products import products_stores_urls
...
urlpatterns = [
  ...
  url(r'^confirmed-delete', delete_product, name='confirmed-delete'),
  url(r'^update', update, name='update'),
  url(r'^search/', include(search_urls.urlpatterns)),
  url(r'^autocomplete/', include(autocomplete_urls.urlpatterns)),
  url(r'^products-stores/', include(products_stores_urls.urlpatterns)),
]